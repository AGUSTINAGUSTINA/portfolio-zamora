...
const CursorEffects = {
	init() {
		if (window.innerWidth <= 768) return; // No en dispositivos m髒iles
	...
	trackMouse() {
		document.addEventListener('mousemove', (e) => {
			...
			// Actualizar posici贸n del punto
			this.cursorDot.style.left = x + 'px';
			this.cursorDot.style.top = y + 'px';

			// Actualizar posici贸n del c铆rculo con delay
			setTimeout(() => {
...
// ==================== REVEAL ON SCROLL ====================
// Revelar elementos con animaci贸n al scrollear
...
// ==================== MORPHING BUTTONS ====================
// Botones con efectos morfol贸gicos
